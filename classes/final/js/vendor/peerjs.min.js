        ...
        "wJlv": [function(require, module, exports) {
            ...
            var e = this && this.__extends || function() {
                ...
                t = this && this.__read || function(e, t) {
                    ...
                    } catch (c) { r = { error: c } } finally { try { n && !n.done && (s = o.return) && s.call(o) } finally { if (r) throw r.error } }
                    return i
                },
            ...
            var o = require("eventemitter3"),
                ...
                c = require("./enums"),
                a = function(t) {
                    function r(e, s, n, r, o, i) {
                        void 0 === i && (i = 5e3);
                        var c = t.call(this) || this;
                        c.pingInterval = i, c._disconnected = !1, c._messagesQueue = [];
                        var a = e ? "wss://" : "ws://";
                        return c._wsUrl = a + s + ":" + n + r + "peerjs?key=" + o, c
                    }
                    return e(r, t), r.prototype.start = function(e, t) { this._id = e, this._wsUrl += "&id=" + e + "&token=" + t, this._startWebSocket() }, r.prototype._startWebSocket = function() {
                        var e = this;
                        ...
                        var e, t, r = s(this._messagesQueue);
                        this._messagesQueue = [];
                        try {
                            for (var o = n(r), i = o.next(); !i.done; i = o.next()) {
                                var c = i.value;
                                this.send(c)
                            }
                        } catch (a) { e = { error: a } } finally { try { i && !i.done && (t = o.return) && t.call(o) } finally { if (e) throw e.error } }
                    ...
                    }, r.prototype.close = function() {!this._disconnected && this._socket && (this._socket.close(), this._disconnected = !0, clearTimeout(this._wsPingTimer)) }, r
                }(o.EventEmitter);
            exports.Socket = a;
                        ...
                        a.default.log("Listening for ICE candidates."), e.onicecandidate = function(e) { e.candidate && (a.default.log("Received ICE candidates for:", t), r.socket.send({ type: l.ServerMessageType.Candidate, payload: { candidate: e.candidate, type: i, connectionId: o }, dst: t })) }, e.oniceconnectionstatechange = function() {
                            switch (e.iceConnectionState) {
                                case "failed":
                                    ...
                                    break;
                                case "closed":
                                    a.default.log("iceConnectionState is closed, closing connections to " + t), n.connection.emit(l.ConnectionEventType.Error, new Error("Connection to " + t + " closed.")), n.connection.close();
                                    break;
                                case "disconnected":
                                    a.default.log("iceConnectionState is disconnected, closing connections to " + t), n.connection.emit(l.ConnectionEventType.Error, new Error("Connection to " + t + " disconnected.")), n.connection.close();
                                    break;
                                case "completed":
                ...
                c = function(r) {
                    ...
                    return e(l, r), Object.defineProperty(l.prototype, "type", { get: function() { return s.ConnectionType.Media }, enumerable: !0, configurable: !0 }), Object.defineProperty(l.prototype, "localStream", { get: function() { return this._localStream }, enumerable: !0, configurable: !0 }), Object.defineProperty(l.prototype, "remoteStream", { get: function() { return this._remoteStream }, enumerable: !0, configurable: !0 }), l.prototype.addStream = function(e) { i.default.log("Receiving stream", e), this._remoteStream = e, r.prototype.emit.call(this, s.ConnectionEventType.Stream, e) }, l.prototype.handleMessage = function(e) {
                        ...
                        if (void 0 === r && (r = {}), this._localStream) i.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
                            ...
                            this._localStream = e, r && r.sdpTransform && (this.options.sdpTransform = r.sdpTransform), this._negotiator.startConnection(t({}, this.options._payload, { _stream: e }));
                ...
                l = function(n) {
                    ...
                    return e(u, n), Object.defineProperty(u.prototype, "type", { get: function() { return s.ConnectionType.Data }, enumerable: !0, configurable: !0 }), Object.defineProperty(u.prototype, "dataChannel", { get: function() { return this._dc }, enumerable: !0, configurable: !0 }), Object.defineProperty(u.prototype, "bufferSize", { get: function() { return this._bufferSize }, enumerable: !0, configurable: !0 }), u.prototype.initialize = function(e) { this._dc = e, this._configureDataChannel() }, u.prototype._configureDataChannel = function() {
                        ...
                        if (this.serialization === s.SerializationType.Binary || this.serialization === s.SerializationType.BinaryUTF8) {
                            if (o === Blob) return void r.util.blobToArrayBuffer(i, function(e) {
                                var n = r.util.unpack(e);
                                t.emit(s.ConnectionEventType.Data, n)
                            });
                            if (o === ArrayBuffer) a = r.util.unpack(i);
                            else if (o === String) {
                                var u = r.util.binaryStringToArrayBuffer(i);
                                a = r.util.unpack(u)
                            }
                        } else this.serialization === s.SerializationType.JSON && (a = JSON.parse(i));
                        a.__peerData ? this._handleChunk(a) : n.prototype.emit.call(this, s.ConnectionEventType.Data, a)
                    }, u.prototype._handleChunk = function(e) {
                        var t = e.__peerData,
                    ...
                    }, u.prototype.close = function() { this._buffer = [], this._bufferSize = 0, this._chunkedData = {}, this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this.provider && (this.provider._removeConnection(this), this.provider = null), this.open && (this._open = !1, n.prototype.emit.call(this, s.ConnectionEventType.Close)) }, u.prototype.send = function(e, t) {
                        var i = this;
                        if (this.open)
