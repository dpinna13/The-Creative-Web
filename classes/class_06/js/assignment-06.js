var scene, renderer;
var camera, cameraControl, sound1;
var shouldRaycast;
...
function init() {
    ...
    oscillator.frequency.setValueAtTime(454, sound1.context.currentTime);
    oscillator.start(0);
    ...
    var oscillator = listener.context.createOscillator();
    oscillator.type = 'sine';
    oscillator.frequency.setValueAtTime(4328, sound2.context.currentTime);
    oscillator.start(0);
    sound2.setNodeSource(oscillator);
    ...
    var oscillator = listener.context.createOscillator();
    oscillator.type = 'sine';
    oscillator.frequency.setValueAtTime(1328, sound3.context.currentTime);
    oscillator.start(0);
...
function render() {
    ...
    // earth.emissive.b = analyser1.getAverageFrequency() / 256;
